...
import com.project.agentBackend.model.reservations.Komentar;
...
public class Sj {
     ...
     * 
     */
    public List<Sj.Slike> getSlike() {
        if (slike == null) {
            slike = new ArrayList<Sj.Slike>();
        }
        return this.slike;
    }
