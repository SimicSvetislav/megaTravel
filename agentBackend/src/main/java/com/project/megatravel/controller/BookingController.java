...
public class BookingController {
	...
	public ResponseEntity<List<TRezervacija>> getAllBookingsPreview(@PathVariable("agentId") String agentId) {
		
		
		return new ResponseEntity<>(new ArrayList<TRezervacija>(), HttpStatus.OK);
	}
	
	@RequestMapping(value="", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE,  produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<TRezervacija> makeBooking(@RequestBody TRezervacija booking) {
		
		
		return new ResponseEntity<>(new TRezervacija(), HttpStatus.CREATED);
	}
	
	@RequestMapping(value="/{bookingId}", method = RequestMethod.GET,  produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<TRezervacija> getBooking(@PathVariable("bookingId") String bookingId) {
		
		
		return new ResponseEntity<>(new TRezervacija(), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<TRezervacija>> confirmBooking(@PathVariable("bookingId") String bookingId) {
