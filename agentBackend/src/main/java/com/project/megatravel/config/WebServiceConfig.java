...
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema) {
		...
		wsdl11Definition.setTargetNamespace("www.model.megatravel.project.com/messages/agent/managment");
	...
	public XsdSchema ratingSchema() {
		return new SimpleXsdSchema(new ClassPathResource("schemas/OceneManagment.xsd"));
	}
