...
public class SmestajniObjekat {
    ...
    public void setSmestajnaJedinica(List<SmestajnaJedinica> lista) {
    	this.smestajnaJedinica = lista;
    }
    
    public void setDodatnaUsluga(List<DodatnaUsluga> lista) {
    	this.dodatnaUsluga = lista;
    }
