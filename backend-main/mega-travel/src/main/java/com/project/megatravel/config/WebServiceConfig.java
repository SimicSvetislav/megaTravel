...
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	//url wsdl: http://localhost:8111/ws/agentBackend.wsdl 
	...
	//url wsdl: http://localhost:8111/ws/accomodationRating.wsdl 
	...
	//url wsdl: http://localhost:8111/ws/accomodation.wsdl 
	...
	//url wsdl: http://localhost:8111/ws/booking.wsdl 
	@Bean(name = "booking")
